  ...
  <section class="content-header">
    <h1>Data Cannery </h1>
     <ol class="breadcrumb">
      ...
      <li class="active">Data All Shift</li>
    </ol>
  </section>
      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">Data Resume Proses Cannery ALL Shifts</h3>
            <div class="btn-group pull-right">            

              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal">
                <i class="fa fa-plus"></i> &nbsp Tambah Data Semua Shift(ALL)
              </button>
            </div>
          </div>
          <div class="box-body">
            ...
            <!-- Modal -->
            <form action="transaksi_act_all.php" method="post">
              <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title" id="exampleModalLabel">Tambah Data Semua Shift(ALL)</h4>
      ...
      <table class="table table-bordered table-striped" id="table-datatable" cellspacing="0" width="50%">
          <thead>
            <tr>
                        ...
                        <th class="text-center">Choice Total</th>
                        <th>OPSI</th>
            </tr>
          </thead>
          <tbody>
            <?php
              ...
              $no=1;
              $data = mysqli_query($koneksi, "select * from resume_cannery_all") or die(mysqli_error($koneksi));
          ...
          <tr>
           ...
           <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit_transaksi_<?php echo $d['id'] ?>">
             ...
             <form action="transaksi_update_all.php" method="post">
                                ...
                                <div class="modal-body">
                                 ...
                                 <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <select name="shift" style="width:100%" class="form-control" required="required">
                                      <option value="">- Pilih -</option>
                                      <option <?php if($d['shift'] == "all"){echo "selected='selected'";} ?> value="all">ALL</option>
                                    </select>
                                  </div>
                        ...
                        <div class="modal fade" id="hapus_transaksi_<?php echo $d['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="transaksi_hapus_all.php?id=<?php echo $d['id'] ?>" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
