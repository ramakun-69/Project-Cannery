      ...
      <section class="col-lg-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs pull-right">
            ...
            <li class="pull-left header">Grafik Nanas A2.5</li>
          </ul>
          <div class="tab-content" style="padding: 20px">
            <div class="chart tab-pane active" id="tab1">
              ...
              <h4 class="text-center">Grafik Data Nanas A2.5 Per <b>Hari</b></h4>
              ...
              <h4 class="text-center">Grafik Data Nanas A2.5 Per <b>Tahun</b></h4>
