      ...
      <section class="col-lg-12">
        ...
        <div class="nav-tabs-custom">
          ...
          <ul class="nav nav-tabs pull-right">
            ...
            <li class="pull-left header">Grafik Data Kapasitas</li>
          </ul>
          ...
          <form  method="post">
            ...
            <h4 class="text-center">Grafik Data Kapasitas  Per <b>Hari</b></h4>
          ...
          <form  method="post">
              ...
              <h4 class="text-center">Grafik Data Kapasitas  Per <b>Tahun</b></h4>
