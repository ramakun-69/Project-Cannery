      ...
      <section class="col-lg-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs pull-right">
            ...
            <li class="pull-left header">Grafik Nanas A10</li>
          </ul>
          <div class="tab-content" style="padding: 20px">
            <div class="chart tab-pane active" id="tab1">
              ...
              <h4 class="text-center">Grafik Data Nanas A10 Per <b>Hari</b></h4>
              ...
              <h4 class="text-center">Grafik Data Nanas A10 Per <b>Tahun</b></h4><button id="downloadChartPDF2" class="btn btn-primary">Unduh Chart</button>
