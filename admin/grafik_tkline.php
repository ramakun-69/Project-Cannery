      ...
      <section class="col-lg-12">
        ...
        <div class="nav-tabs-custom">
          ...
          <ul class="nav nav-tabs pull-right">
            ...
            <li class="pull-left header">Grafik Data Tk Line</li>
          </ul>
          ...
          <div class="tab-content" style="padding: 20px">
            ...
            <h4 class="text-center">Grafik Data Tk Line  Per <b>Hari</b></h4>
            ...
            <form  method="post">
              ...
              <h4 class="text-center">Grafik Data Tk Line  Per <b>Tahun</b></h4>
