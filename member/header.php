...
<head>
  ...
  include '../koneksi.php';
  session_start();
  if ($_SESSION['status'] != "member_logedin") {
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              ...
              <li><a href="grafik_mppsc.php"><i class="fa fa-circle-o"></i> Grafik MPP/SC<br>(Man Power Productivity)</a></li>
              <li><a href="grafik_kapasitas.php"><i class="fa fa-circle-o"></i> Grafik Data Kapasitas</a></li>
              <li><a href="grafik_mppkg.php"><i class="fa fa-circle-o"></i> Grafik MPP/KG<br>(Man Power Productivity)</a></li>
