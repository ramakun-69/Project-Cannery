...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Jan 2024 pada 15.59
...
--
-- Struktur dari tabel `resume_cannery_a`
--

CREATE TABLE `resume_cannery_a` (
  `id` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `shift` enum('A') CHARACTER SET utf8 NOT NULL,
...
--
-- Dumping data untuk tabel `resume_cannery_a`
--
...
--
-- Struktur dari tabel `resume_cannery_all`
--

CREATE TABLE `resume_cannery_all` (
  `id` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `shift` enum('ALL') CHARACTER SET utf8 NOT NULL,
  `tkline` varchar(20) NOT NULL,
  `tktidakhadir` varchar(20) NOT NULL,
  `tkproduksi` varchar(20) NOT NULL,
  `tonaseproses` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `resume_cannery_all`
--
...
--
-- Struktur dari tabel `resume_cannery_b`
--

CREATE TABLE `resume_cannery_b` (
  `id` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `shift` enum('B') CHARACTER SET utf8 NOT NULL,
  `tkline` varchar(20) NOT NULL,
  `tktidakhadir` varchar(20) NOT NULL,
  `tkproduksi` varchar(20) NOT NULL,
  `tonaseproses` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `resume_cannery_b`
--
...
--
-- Struktur dari tabel `resume_cannery_bulanan`
--

CREATE TABLE `resume_cannery_bulanan` (
  `id` int(11) NOT NULL,
  `bulan` enum('januari','februari','maret','april','mei','juni','juli','agustus','september','oktober','november','desember') CHARACTER SET utf8 NOT NULL,
  `tahun` enum('2022','2023','2024','2025') CHARACTER SET utf8 NOT NULL,
  `tkline` varchar(20) NOT NULL,
  `tktidakhadir` varchar(20) NOT NULL,
  `tkproduksi` varchar(20) NOT NULL,
  `tonaseproses` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `resume_cannery_bulanan`
--
...
(1, '&lt;p&gt;Great Giant Foods, yang diluncurkan pada 2016, merupakan brand entity di bidang produk buah segar, buah olahan, makanan dan minuman dalam kemasan, seperti jus, protein, dan susu, serta&lt;br /&gt;\r\ntepung tapioka yang dipasarkan di bawah merek dagang Sunpride, Duta, Oriji, Re.juve, Bonanza,&lt;br /&gt;\r\nHometown, dan Cap Kodok. Produk unggulan kami, nanas kaleng, tersebar dilebih dari 60 negara. Hal tersebut menjadikan kami sebagai tiga besar produsen nanas kaleng di dunia dengan pengolahan limbah, pabrik, dan kebun yang terintegrasi. Dalam mengembangkan usaha, kami menerapkan konsep pertanian dan peternakan berkesinambungan dengan standar yang tinggi,&lt;br /&gt;\r\nmodern, ramah lingkungan, dan inovatif, untuk menjamin ketersediaan produk-produk makanan berkualitas&lt;/p&gt;\r\n', '(0721) 31342', 'Jalan Raya Arah Menggala - Km.77,Terbanggi Besar,Kabupaten Lampung Tengah', 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63612.111928814!2d105.1411632113922!3d-4.81173633133824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e40a7e295c66255%3A0xad1d65f525485588!2sGreat%20Giant%20Pineapple%20-%20Plantation!5e0!3m2!1sid!2sid!4v1704269915718!5m2!1sid!2sid');
...
(4, 'kebun nanas', '2122665964_kebun-nanas2.jpg');
...
--
-- Indeks untuk tabel `resume_cannery_a`
--
ALTER TABLE `resume_cannery_a`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `resume_cannery_all`
--
ALTER TABLE `resume_cannery_all`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `resume_cannery_b`
--
ALTER TABLE `resume_cannery_b`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `resume_cannery_bulanan`
--
...
--
-- AUTO_INCREMENT untuk tabel `resume_cannery_a`
--
ALTER TABLE `resume_cannery_a`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT untuk tabel `resume_cannery_all`
--
ALTER TABLE `resume_cannery_all`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT untuk tabel `resume_cannery_b`
--
ALTER TABLE `resume_cannery_b`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT untuk tabel `resume_cannery_bulanan`
--
ALTER TABLE `resume_cannery_bulanan`
